...
- [x] **P2 发布闭环**：发布(3步) · AI 估价/文案 · 我的发布(状态管理)
- [x] **P3 沟通闭环**：消息列表 · 聊天 · 约交易地点 · 标记已售出
- [x] **P4 后台**：数据概览 · 用户 / 商品 / 认证 / 举报管理（`/admin`）

> 后台演示：在「我的」用 🦊 登录后退出，改用 `/admin` 一键管理员登录；
> 或学生端「我的」页对管理员显示「进入管理后台」。
